...
window.PRODUCT_INDICATORS = {
  "chicotes-montados-3-unidades": {
    ...
    "meia-agua-capa.webp":       { tipo: "Meia Água", medida: "1,15m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "fundo-capa-180.webp":       { tipo: "Fundo",     medida: "1,80m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "chicote-finesse-capa.webp": { tipo: "Finesse",   medida: "0,85m", linha: "incolor",  pontas: "nó",       componente: "engate" },
    "modelo-13.png": { tipo: "Beira",     medida: "1m",    linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-14.png": { tipo: "Beira",     medida: "1m",    linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-09.png": { tipo: "Meia Água", medida: "1,15m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-10.png": { tipo: "Meia Água", medida: "1,15m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-11.png": { tipo: "Meia Água", medida: "1,15m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-12.png": { tipo: "Meia Água", medida: "1,15m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-01.png": { tipo: "Fundo", medida: "1,30m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-02.png": { tipo: "Fundo", medida: "1,30m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-03.png": { tipo: "Fundo", medida: "1,30m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-04.png": { tipo: "Fundo", medida: "1,30m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-17.png": { tipo: "Fundo", medida: "1,30m", linha: "incolor",  pontas: "nó", componente: "miçanga" },
    "modelo-18.png": { tipo: "Fundo", medida: "1,30m", linha: "incolor",  pontas: "nó", componente: "miçanga" },
    "modelo-05.png": { tipo: "Fundo", medida: "1,80m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-06.png": { tipo: "Fundo", medida: "1,80m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-07.png": { tipo: "Fundo", medida: "1,80m", linha: "vermelha", pontas: "stopper", componente: "engate" },
    "modelo-08.png": { tipo: "Fundo", medida: "1,80m", linha: "incolor",  pontas: "stopper", componente: "engate" },
    "modelo-15.png": { tipo: "Fundo", medida: "1,80m", linha: "incolor",  pontas: "nó", componente: "miçanga" },
    "modelo-16.png": { tipo: "Fundo", medida: "1,80m", linha: "incolor",  pontas: "nó", componente: "miçanga" },
...
window.PRODUCTS = [
  ...
  },
  {
    ...
    "videos": [
      "assets/video/shopify/secretaria-paredao-uso.mp4",
      "assets/video/shopify/secretaria-paredao-uso-02.mp4"
    ],
    "specs": {
      "Cor": "Preto Eco"
    },
  ...
  },
  {
    ...
    "images": [
      "assets/img/shopify/no-de-correr-capa.png",
      "assets/img/shopify/no-de-correr-p-embalagem.png",
      "assets/img/shopify/no-de-correr-p-embalagem-costas.png",
      "assets/img/shopify/no-de-correr-m-embalagem.png"
    ],
    "video": "",
    "specs": {
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/StopperP2_38b5983f-b1ee-449f-b6c8-58ecb14ea751.jpg",
      "assets/img/shopify/StopperM2_f4649fb4-bd6b-4bf4-a45b-d044d76daff2.jpg",
      "assets/img/shopify/StopperG2_28f89b31-445e-4f75-af2c-5948993bd089.jpg"
    ],
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/Embalagem-Stopper-cilindrico-M.png",
      "assets/img/shopify/Embalagem-Stopper-cilindrico-P.png",
      "assets/img/shopify/Embalagem-Stopper-cilindrico-G.png",
      "assets/img/shopify/Stopper-cilindrico-G_d22c0f54-7417-4703-ad9b-cf8e4e892443.png",
      "assets/img/shopify/Stopper-cilindrico-M_e5d28792-032c-4b56-97f1-3c63cc258644.png",
      "assets/img/shopify/Stopper-cilindrico-P_ebba56f0-32d5-4c1c-8cb5-51640feb938c.png"
    ],
    "video": "assets/video/shopify/ef8ebb2364fb477a9b7803972081da0f.mp4",
    "specs": {
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/Embalagem-Destorcedor-7mm-frente_7d725e2c-c338-441b-a3bf-6d24d3ef9efd.jpg",
      "assets/img/shopify/Embalagem-Destorcedor-7mm-costas_851d4736-5ede-44da-a0e7-71992bb16625.jpg",
      "assets/img/shopify/Embalagem-Destorcedor-11mm-frente_7a63ff66-1128-43fb-b0ed-218881a7b7a0.jpg",
      "assets/img/shopify/Embalagem-Destorcedor-15mm-frente_cdef0adb-af66-48d7-9cba-d566d20e1d64.jpg",
      "assets/img/shopify/Embalagem-Destorcedor-25mm-frente_d004420e-131f-4f4c-a953-bb0e8385bdaa.jpg"
    ],
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/destorcedor-triplo-15mm-frente.png",
      "assets/img/shopify/destorcedor-triplo-15mm-costas.png",
      "assets/img/shopify/destorcedor-triplo-15mm_e9fd3333-5e84-4c73-886f-0e17e084bdab.png",
      "assets/img/shopify/destorcedor-triplo-19mm-frente.png",
      "assets/img/shopify/destorcedor-triplo-19mm-costas.png",
      "assets/img/shopify/destorcedor-triplo-19mm_9443e4fb-981e-4eb6-95d3-19d73f22d3e9.png",
      "assets/img/shopify/destorcedor-triplo-23mm_077c725c-c087-44f0-9a03-95a9d69b8340.png",
      "assets/img/shopify/destorcedor-triplo-28mm_79eab599-5db1-4d34-9966-3cb67d55f179.png",
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/Snap-Single-13mm-un_463d89cf-d68e-4935-8c19-8b3f9fb6df81.png",
      "assets/img/shopify/Snap-Single-8mm-4kg-un_07f8d7fb-b8fb-436c-8db3-787cb7a1020f.png"
    ],
    "video": "",
    "specs": {
      "Material": "Aço inoxidável de alta resistência",
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/Snap-Double-17mm-1-un_0bd78efc-05f3-4294-86f2-7249fde20eeb.png",
      "assets/img/shopify/Snap-Double-12mm-1-un_73d8bebd-5016-4f1e-b2ce-d3faa34313b2.png"
    ],
    "video": "",
    "specs": {
      "Material": "Aço inoxidável de alta resistência",
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/Snap-Frances-30mm-frente.jpg",
      "assets/img/shopify/Snap-Frances-25mm-frente.jpg",
      "assets/img/shopify/Snap-Frances-20mm-frente.jpg",
      "assets/img/shopify/Snap-Frances-18mm-frente.jpg",
      "assets/img/shopify/Snap-Frances-15mm-frente.jpg",
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/modelo-13.png",
      "assets/img/shopify/modelo-14.png",
      "assets/img/shopify/meia-agua-capa.webp",
      "assets/img/shopify/modelo-09.png",
      "assets/img/shopify/modelo-10.png",
      "assets/img/shopify/modelo-11.png",
      "assets/img/shopify/modelo-12.png",
      "assets/img/shopify/fundo-capa.webp",
      "assets/img/shopify/modelo-01.png",
      "assets/img/shopify/modelo-02.png",
      "assets/img/shopify/modelo-03.png",
      "assets/img/shopify/modelo-04.png",
      "assets/img/shopify/modelo-17.png",
      "assets/img/shopify/modelo-18.png",
      "assets/img/shopify/fundo-capa-180.webp",
      "assets/img/shopify/modelo-05.png",
      "assets/img/shopify/modelo-06.png",
      "assets/img/shopify/modelo-07.png",
      "assets/img/shopify/modelo-08.png",
      "assets/img/shopify/modelo-15.png",
      "assets/img/shopify/modelo-16.png",
  ...
  },
  {
    ...
    "price": "R$ 11,00",
    "img": "assets/img/shopify/nano-pipe-capa.png",
    "link": "https://chumbadas.com.br/products/nano-pipe-borracha-cano-1?utm_source=copyToPasteBoard&utm_medium=product-links&utm_content=web",
    "swatches": [
      [
        "Verde",
        "#22c55e"
  ...
  },
  {
    ...
    "images": [
      ...
      "assets/img/shopify/azul-40.jpg",
      "assets/img/shopify/azul-60.jpg",
      "assets/img/shopify/azul-85.jpg",
      "assets/img/shopify/azul-escuro-grande.png",
      "assets/img/shopify/azul-escuro-medio.png",
      "assets/img/shopify/Azul-escuro-pequeno.png",
      ...
      "assets/img/shopify/vermelho-40.jpg",
      "assets/img/shopify/vermelho-60.jpg",
      "assets/img/shopify/vermelho-85.jpg",
  ...
  },
  {
    ...
    "description": "<p>Suporte Horizontal – Precisão e Praticidade para sua Pescaria</p>\n<p>O Suporte Horizontal foi desenvolvido para oferecer conforto, precisão e agilidade durante a pescaria. Ele mantém a vara paralela ao chão, em um ângulo de 90° em relação ao corpo do pescador, o que torna o movimento de fisgada mais rápido e natural no momento em que a vara é retirada do suporte.</p>\n<p>Ideal para pescarias finesse, de tilápia e carpas, onde a observação da linha é essencial, o Suporte Horizontal permite que o pescador fique atento aos mínimos movimentos. Também é perfeito para quando você está iscando ou preparando outra vara, mantendo a ponta da vara sempre visível.</p>\n<p>Versátil e resistente. Fabricado com termoplástico de engenharia.<br>Em dias de vento, ele é muito útil, pois com a vara abaixada teremos menos incidência do vento sobre a linha.</p>\n<p>É extremamente útil em plataformas de pesca e pesqueiros, especialmente em campeonatos, onde a agilidade faz a diferença.</p>\n<p>Compatível com os nossos Suportes Slim e Suportes Premium, ele pode ser adquirido separadamente e acoplado facilmente às cantoneiras existentes.</p>\n<p>Disponível nos tamanhos:<br>40 cm, 60 cm, 85 cm, 1 m e 1,20 m – montado e pronto para uso.<br>Escolha o tamanho ideal de acordo com o tipo de pescaria e altura do suporte desejada.</p>\n<p>Seja para pesca de fundo ou para pesca onde é necessário observar a linha, o Suporte Horizontal é o aliado certo para elevar sua performance na beira d’água.</p>",
    "images": [
      "assets/img/shopify/photo_2025-03-24_07-29-37_2.jpg",
      "assets/img/shopify/photo_2025-03-24_07-29-37.jpg",
      "assets/img/shopify/Suporte-horizontal-completo-close.jpg",
      "assets/img/shopify/Suporte-horizontal-05.jpg",
      "assets/img/shopify/Suporte-horizontal-barra.jpg",
      "assets/img/shopify/Suporte-horizontal-completo.jpg"
    ],
    "video": "assets/video/shopify/83845fc30b594b96a4169d4930aa675d.mp4",
    "specs": {
  ...
  },
  {
    ...
    "images": [
      "assets/img/shopify/apoio-para-barco.png",
      "assets/img/shopify/suporte-de-barco-capa.png"
    ],
    "video": "",
    "specs": {
  ...
  },
  {
    ...
    "description": "<p>Suporte para Carretilha e Molinete – Chumbada Oficial</p>\n<p>Mantenha seus equipamentos organizados e sempre prontos para ação com o Suporte para Carretilha e Molinete da Chumbada Oficial!</p>\n<p>Desenvolvido para comportar a maioria dos molinetes e carretilhas disponíveis no mercado, esse suporte é a solução ideal para quem busca praticidade e otimização de espaço.</p>\n<p>✔️ Kit completo com 4 peças<br>✔️ Instalação vertical, perfeita para locais com pouco espaço<br>✔️ Compatível com diversos modelos de carretilha e molinete<br>✔️ Disponível em diversas cores<br>✔️ Acompanha 4 buchas e 4 parafusos para fácil instalação</p>\n<p>Ideal para organizar seu equipamento de pesca em casa, na garagem, atras de portas. Praticidade, segurança e eficiência em um só produto!</p>",
    "images": [
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-capa.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-preto.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-vermelho.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-rosa.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-azul.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-amarelo.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-verde.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-laranja.png",
      "assets/img/shopify/Suporte-para-carretilha-e-molinete-individual-branco.png",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-branco.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-rosa.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-laranja.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-verde.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-amarelo.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-preto.jpg",
      "assets/img/shopify/suporte-para-carretilha-individual-solapa-azul.jpg",
  ...
  },
  {
    ...
    "img": "assets/img/shopify/c4dd0fe0-b913-4b7f-981a-2bf5407f2337.png",
    "link": "https://chumbadas.com.br/products/copo-organizador?utm_source=copyToPasteBoard&utm_medium=product-links&utm_content=web",
    "vars": [
      [
        "P",
        "a partir de R$ 2,33"
  ...
  },
  {
    ...
    "name": "Varal Chumbada",
    "price": "R$ 169,00",
    "img": "assets/img/shopify/Varal-02.jpg",
    "link": "https://chumbadas.com.br/products/varal-chumbada?utm_source=copyToPasteBoard&utm_medium=product-links&utm_content=web",
    "vars": [
      [
        "Completo",
        "R$ 169,00"
  ...
  },
  {
    ...
    "images": [
      "assets/img/shopify/capa_c9a07c21-e3f8-46d1-a84c-769fe323c1fc.png",
      "assets/img/shopify/capa-3.png",
      "assets/img/shopify/capa-2.png",
      "assets/img/shopify/tamanho.png",
      "assets/img/shopify/modelo_01.jpg",
      "assets/img/shopify/modelo_04.jpg",
      "assets/img/shopify/modelo_05.jpg",
      "assets/img/shopify/protetor_de_bobina_modelo_2_10346397-f337-48ef-a10a-32d021a8c34d.jpg",
      "assets/img/shopify/protetor_de_bobina_modelo_3_656079cc-d3a3-4234-84ff-f7e07f013e39.jpg",
  ...
  },
  {
    ...
    "skuVariants": [{"opts": ["P"], "sku": "MRev0897"}, {"opts": ["M"], "sku": "MRev0898"}, {"opts": ["G"], "sku": "MRev0899"}, {"opts": ["GG"], "sku": "MRev0900"}, {"opts": ["EGG"], "sku": "MRev0901"}, {"opts": ["1XG"], "sku": "MRev0902"}, {"opts": ["2XG"], "sku": "MRev0903"}],
    "section": "Vestuário",
    "category": "Vestuário",
